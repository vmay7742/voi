...
sudo xbps-install -Su xorg libX11-devel libXinerama-devel libXft-devel base-devel bspwm picom sxhkd polybar dmenu feh tmux p7zip curl NetworkManager htop inxi lm_sensors pulseaudio pulsemixer wget bc fzf xclip plocate bash-completion noto-fonts-ttf noto-fonts-cjk scrot Thunar thunar-volman gvfs gvfs-mtp elogind mtpfs ntfs-3g udisks2 ffmpeg ffmpegthumbnailer tumbler xdotool brillo kitty firefox
