...
sudo xbps-install -Su mediainfo yt-dlp qemu ufw sct rxvt-unicode mpv nsxiv nomacs blender darktable hugin gimp gmic-gimp krita inkscape xarchiver libreoffice zathura zathura-pdf-mupdf zathura-djvu zathura-ps zathura-cb obs qbittorrent syncthing keepassxc audacity android-tools android-udev-rules kdeconnect dunst ntp openvpn acpi scrcpy meson ninja libavcodec libavdevice libavformat libavutil libswresample wine wine-mono wine-gecko winetricks
